...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<1|handout:1>
    \code[language=c++14,font=\small]{const-vector1.cpp}

    \onslide<2|handout:2>
    \code[language=c++14,font=\small]{const-vector2.cpp}

    \onslide<3|handout:3>
    \code[language=c++14,font=\small]{const-vector3.cpp}

    \onslide<4|handout:4>
    \code[language=c++14,font=\small]{const-vector4.cpp}
  \end{overprint}
\end{frame}
